...
var peer = fabric_client.newPeer('grpc://host.docker.internal:7051');
channel.addPeer(peer);
var order = fabric_client.newOrderer('grpc://host.docker.internal:7050')
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    if (isProposalGood) {
        ...
        //event_hub.setPeerAddr('grpc://host.docker.internal:7053');
